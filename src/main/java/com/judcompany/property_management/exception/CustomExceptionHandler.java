package com.judcompany.property_management.exception;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<List<ErrorModel>> handleFieldValidation(MethodArgumentNotValidException argument){
        List<ErrorModel> errorModelList = new ArrayList<>();
        ErrorModel errorModel = null;
        List<FieldError> fieldErrorList = argument.getBindingResult().getFieldErrors();
